...
public class OrgMember extends Person {
     ...
     */
    public OrgMember(Name name, Organisation organisation, Phone phone, Email email, Telegram telegram, Set<Tag> tags, Set<Remark> remarks, List<Project> projects) {
        super(name, new Role(RoleType.ORGMEMBER, organisation.toString()), phone, email, telegram, tags, remarks, projects);
