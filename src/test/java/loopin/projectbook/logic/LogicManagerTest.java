...
import static loopin.projectbook.logic.commands.CommandTestUtil.ADDRESS_DESC_AMY;
...
public class LogicManagerTest {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an ProjectBookStorage that throws the IOException e when saving
        JsonProjectBookStorage projectBookStorage = new JsonProjectBookStorage(prefPath) {
            @Override
            public void saveProjectBook(ReadOnlyProjectBook projectBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
